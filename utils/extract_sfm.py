...
def extract_all_to_dir(sparse_dir, out_dir, ext='.bin'):
    ...
    camera_dict_file = os.path.join(out_dir, 'cameras.json')
    xyz_file = os.path.join(out_dir, 'points.txt')
    track_file = os.path.join(out_dir, 'tracks.json')
    keypoints_file = os.path.join(out_dir, 'keypoints.json')
    ...
    mesh.export(os.path.join(out_dir, 'points.ply'))
